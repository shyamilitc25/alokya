          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-12 ms-auto">
                <div className="container">
                  <p className="lead">
                    <b style={{ fontWeight: "bold" }}>2. Hosting</b>
                  </p>
                </div>
              </div>
              <div className="col-lg-12 ms-auto">
            ...
            <div className="row">
              <div className="col-lg-12 ms-auto">
                <div className="container">
                  <p className="lead">
                    <b style={{ fontWeight: "bold" }}>Externes Hosting</b>
                  </p>
                </div>
              </div>
              <div className="col-lg-12 ms-auto">
                <div className="container">
                  <p className="lead">
                    ...
                    TDDDG, soweit die Einwilligung die Speicherung von Cookies
                    ...
                    Bezug auf diese Daten befolgen. Wir setzen folgende(n)
                    <br />
                    <br />
                    Hoster ein: HOSTINGER operations, UAB
                    <br /> Svitrigailos Str.34,Vilinius 03230 Lithuania
                    <br />
                    <br />
                  </p>
                </div>
            ...
            <div className="row">
              <div className="col-lg-12 ms-auto">
                <div className="container">
                  <p className="lead">
                    <b style={{ fontWeight: "bold" }}>Auftragsverarbeitung</b>
                  </p>
                </div>
              </div>
              <div className="col-lg-12 ms-auto">
              ...
              <div className="col-lg-12 ms-auto">
                <div className="container">
                  <p className="lead">
                    ...
                    <br />
                    <b style={{ fontWeight: "bold" }}>Datenschutz</b>
                  </p>
                </div>
              </div>
              <div className="col-lg-12 ms-auto">
                <div className="container">
                  <p className="lead">
                    ...
                    wie und zu welchem Zweck das geschieht. Wir weisen darauf
              ...
              <div className="col-lg-12 ms-auto">
                <div className="container">
                  <p className="lead">
                    ...
                    dieser Website ist:
                    <br /> Akhil Sugathan Amrutha
                    <br />
                    Aleyka Ayurveda ,Weststrasse 37 57392 Schmallenberg
                    <br />
                    Telefon: +49 1605607278 E-Mail: info@aleykaayurveda.de
                    <br />
                    <br />
            ...
            <div className="row">
              <div className="col-lg-12 ms-auto">
                <div className="container">
                  <p className="lead">
                    <b style={{ fontWeight: "bold" }}>Speicherdauer</b>
                  </p>
                </div>
              </div>
              <div className="col-lg-12 ms-auto">
              ...
              <div className="col-lg-12 ms-auto">
                <div className="container">
                  <p className="lead">
                    ...
                    unserer Kunden nur auf Grundlage eines gültigen
                    <br />
                    <br />
              ...
              <div className="col-lg-12 ms-auto">
                <div className="container">
                  <p className="lead">
                    ...
                    Ihrer personenbezogenen Daten zu verlangen. Wenn Sie einen
