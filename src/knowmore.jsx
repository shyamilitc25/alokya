          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-12 ms-auto">
                ...
                <p className="lead bold">
                  1.ayurveda consultation with ayurveda specialist - 90 min
                  -199euro
                </p>
                <p className="lead bold">
                  2.massage 1(40min abyanga +20min padaabyanga) -99euro
                </p>
                <p className="lead bold">
                  3.massage 2(40min abyanga+30min padaabyanga+20min
                  mukhaabyanga) -149euro
                </p>
                <p className="lead bold">
                  4.massage 3(40min abyanga+30min padaabyanga+30min
                  mukhaabyanga+20min shiroabyanga)-199euro
                </p>
              </div>
            </div>
          </div>
